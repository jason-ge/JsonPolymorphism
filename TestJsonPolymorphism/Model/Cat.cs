...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Cat : BasePet,  IEquatable<Cat>, IValidatableObject
    {
        public Cat() { }
        ...
        public Cat(string meow = default(string), string name = default(string), string petType = default(string)) : base(name, petType)
        {
            this.Meow = meow;
        }
        ...
        /// Gets or Sets Meow
        /// </summary>
        [DataMember(Name="meow", EmitDefaultValue=false)]
        ...
        public bool Equals(Cat input)
        {
            ...
            return base.Equals(input) && 
                (
                    this.Meow == input.Meow ||
                    (this.Meow != null &&
                    this.Meow.Equals(input.Meow))
                );
        }
