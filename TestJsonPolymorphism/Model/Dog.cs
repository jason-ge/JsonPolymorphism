...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Dog : BasePet,  IEquatable<Dog>, IValidatableObject
    {
        public Dog() { }
        ...
        public Dog(string bark = default(string), string name = default(string), string petType = default(string)) : base(name, petType)
        {
            this.Bark = bark;
        }
